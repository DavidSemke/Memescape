...
export default function Searchbar({
  ...
  const defaultStyles = {
    ...
    input:
      "pl-12 bg-gone rounded-2xl border-none w-full focus:outline-none focus:ring-stress-primary focus:ring-4",
  }
  ...
  return (
    ...
    >
      <MagnifyingGlassIcon {...attrs.icon} className={styles.icon} />
      <input
        {...attrs.input}
        ref={inputRef}
